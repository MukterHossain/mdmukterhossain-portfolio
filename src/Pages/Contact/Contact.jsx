...
const Contact = () => {
  return (
    <>
      <div className=" w-11/12 sm:w-4/5 md:w-3/5 lg:w-2/5 xl:w-1/4 mx-auto mt-8 my-12 sm:mt-12 md:mt-20 lg:mt-24 xl:mt-32  rounded-md box_shadow  border-2 border-slate-200  p-5 md:px-10 md:py-8 ">
