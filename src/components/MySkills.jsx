...
const MySkills = () => {
  return (
    <div className="rounded-md box_shadow border-spacing-1 h-full border-2 border-slate-200  p-5 md:px-10 md:py-8 my-12 mx-5 md:mx-0">
      <div className="">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-24 gap-y-12 mt-4">
            <div className="bg-gradient-to-r from-lime-100 to-lime-900 flex justify-center items-center gap-3 border-2 border-slate-200 py-2 rounded-lg" >
